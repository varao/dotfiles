...
fzf() {
  /usr/bin/ruby --disable-gems /home/varao/.fzf/fzf "$@"
}
export -f fzf > /dev/null

# Auto-completion
# ---------------
[[ $- =~ i ]] && source /home/varao/.fzf/fzf-completion.bash
...
if [ -z "$(set -o | \grep '^vi.*on')" ]; then
  ...
  # Vinayak: I had to comment out the line below to avoid extra <CR>
  ...
  bind '"\C-r": " \C-e\C-u$(HISTTIMEFORMAT= history | fzf +s +m -n2..,.. | sed \"s/ *[0-9]* *//\")\e\C-e"'
